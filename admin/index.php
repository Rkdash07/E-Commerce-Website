...
$query = "SELECT COUNT(*) AS pending_orders FROM `order` WHERE order_status = '0' OR order_status = '1'";
$result = $conn->query($query);
$row = $result->fetch_assoc();
$pendingOrders = $row['pending_orders'];

$query = "SELECT COUNT(*) AS shipped_orders FROM `order` WHERE order_status = '2'";
$result = $conn->query($query);
$row = $result->fetch_assoc();
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              ...
              <a href="logout.php" class="nav-link text-primary">Logout</a>';
                ...
                echo '<a href="login.php" class="nav-link text-primary">Login</a>';
