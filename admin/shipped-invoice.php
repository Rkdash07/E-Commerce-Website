...
//     exit;
// }
// Fetch shipping details for this order from shipped_orders
$shippingData = null;
$stmt_ship = $conn->prepare("SELECT * FROM shipped_orders WHERE orderId = ? LIMIT 1");
$stmt_ship->bind_param("i", $orderId);
$stmt_ship->execute();
$result_ship = $stmt_ship->get_result();
if ($result_ship && $result_ship->num_rows > 0) {
    $shippingData = $result_ship->fetch_assoc();
}
$stmt_ship->close();
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Shipping Invoice</h3>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="card card-outline card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        Order ID: <b>ORD-<?php echo htmlspecialchars($orderData['id']); ?></b><br>
                                ...
                                <div class="col-md-6">
                                    <div class="container-fluid p-4">
                                        <div class="form-group my-2">
                                            <label for="" class="fw-bold col-md-3 mb-3">courier image </label>
                                            <div>
                                           <?php if ($shippingData && $shippingData['image_url']): ?>
                                           <img src="<?= htmlspecialchars($shippingData['image_url']) ?>" width="100" height="75" alt="Courier Image">
                                           <?php else: ?>
                                           <img src="./assets/img/avatar.png" width="100" height="75" alt="No Image">
                                           <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <div class="form-group my-2">
                                            <label class="fw-bold col-md-3">mode of delivery: </label>
                                            <span><?= $shippingData ? htmlspecialchars($shippingData['shipping_mode']) : 'N/A'; ?></span>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="fw-bold col-md-3"> Delivery Date:</label>
                                            <span><?= $shippingData && $shippingData['date_of_shipping'] ? date('d/m/Y', strtotime($shippingData['date_of_shipping'])) : 'N/A'; ?></span>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="fw-bold col-md-3">Shipping Charges:</label>
                                            <span>₹<?= $shippingData ? number_format($shippingData['charges'], 2) : 'N/A'; ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 me-4">
                                    <p class="card-header fw-bold">Order Total:</p>
                                    <table class="table">
                                        <tr>
                                            <th>Subtotal:</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>₹<?= number_format($total, 2); ?></strong>
                                                <label for="total_charges" class="visually-hidden">Additional
                                                    Charges</label>
                                  ...
                                  <?php
                 $shipping_charges = ($shippingData && $shippingData['charges']) ? floatval($shippingData['charges']) : 0;
                 $delivery_charges = 80;
                 $grand_total = $total + $shipping_charges + $delivery_charges;
            ?>
            <div class="col-md-5  ">
              <p class="card-header fw-bold">Grand Total</p>
              <table class="table">
                <tr>
                  <th>Order Total:</th>
                ...
                <tr>
                  ...
                  <td>+ ₹ <?= number_format($shipping_charges,2)?></td>
                </tr>
                
                <tr>
                  <th>Total:</th>
                  <td><strong>₹ <?= number_format($grand_total,2) ?></strong>
                </table>
            </div>
                        ...
                        <button class="m-2 btn btn-secondary" type="button" onclick="window.print();">
